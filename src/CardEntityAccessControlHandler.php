...
/**
 * Access controller for the Card entity entity.
 *
 * @see \Drupal\tribute_cards\Entity\CardEntity.
 */
class CardEntityAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    ...
    switch ($operation) {
      ...
      case 'view':
        ...
        //   return AccessResult::allowedIfHasPermission($account, 'view unpublished card entity entities');
        // }
        ...
        return AccessResult::allowedIfHasPermission($account, 'view card entity entities');
      ...
      case 'update':
        ...
        return AccessResult::allowedIfHasPermission($account, 'edit card entity entities');
      ...
      case 'delete':
        ...
        return AccessResult::allowedIfHasPermission($account, 'delete card entity entities');
    }
  ...
  protected function checkCreateAccess(AccountInterface $account, array $context, $entity_bundle = NULL) {
    return AccessResult::allowedIfHasPermission($account, 'add card entity entities');
  }
